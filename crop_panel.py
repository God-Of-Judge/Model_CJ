...
target_dir = "/content/drive/MyDrive/Colab Notebooks/yolov5-master/yolov5-master/dataset/0"
...
path = "/content/drive/MyDrive/Colab Notebooks/yolov5-master/yolov5-master/dataset/image"
...
for imgname in imgnames:
    ...
    for d in json_data["annotation"]:
        if d["class"] == "traffic_light" and d["type"] == "car" and d["direction"]=="horizontal":
            ...
            dstpath = target_dir+"/"+ imgname.replace(".jpg","").replace(".png","") + " " + str(index)+".png"
